...
fun main() {
     ...
     *
     */
        // Membuat instance dari kelas Hero dan mengisinya ke dalam variabel hero
        val hero = Hero()
     ...
     *
     */
    hero.setProfile("Nanda Aprillia Lestari Mufti", 20, 150)
     ...
     *
     */
        // Menampilkan data profile sebelum melakukan aktivitas
    ...
    **/
    ...
    // Fungsi untuk menampilkan status terkini
    println("\nData terkini setelah aktivitas :")
    hero.profile()
}
